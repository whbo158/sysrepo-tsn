...
int qci_sf_subtree_change_cb(sr_session_ctx_t *session, const char *mod_name,
		const char *path, sr_event_t event,
		uint32_t id, void *private_ctx);
int qci_sg_subtree_change_cb(sr_session_ctx_t *session, const char *mod_name,
		const char *path, sr_event_t event,
		uint32_t id, void *private_ctx);
int qci_fm_subtree_change_cb(sr_session_ctx_t *session, const char *mod_name,
		const char *path, sr_event_t event,
		uint32_t id, void *private_ctx);
